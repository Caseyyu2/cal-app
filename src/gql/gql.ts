 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateActivity($id: ID!, $input: UpdateActivityInput!) {\n  updateActivity(id: $id, input: $input) {\n    id\n    title\n    description\n    location\n    startTime\n    endTime\n    category\n  }\n}\n\nmutation DeleteActivity($id: ID!) {\n  deleteActivity(id: $id)\n}"): (typeof documents)["mutation UpdateActivity($id: ID!, $input: UpdateActivityInput!) {\n  updateActivity(id: $id, input: $input) {\n    id\n    title\n    description\n    location\n    startTime\n    endTime\n    category\n  }\n}\n\nmutation DeleteActivity($id: ID!) {\n  deleteActivity(id: $id)\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
